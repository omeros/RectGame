...
public class SqareGameOld  extends JFrame //Throws IOException
{
	 ...
	 /*********************************************************************************************************/
		{
			...
			public void actionPerformed(ActionEvent event)
			{
		   		...
		   		if(event.getSource()==add)            //               Add Button
				{
		  		...
		  		if(event.getSource()==clear)                // clear Button
				{
		  			panel2.clear();	
		  			panel2.started();
		  			panel2.repaint();
				...
				{
			       panel2.finish();
			       // change to "Algoquest" for running the demo mode
		  	       Algoquest a= new Algoquest();    // <==========================
		  	       BoundList list2;
		  	       Bound out;
		  	       Object[] bon = panel2.getArr();
//		  	       if( bon[0] instanceof Bound )
//		  	       {
...
//		  	       }  S
		  	   ...
		  	   System.out.println(" ");
		  		...
		  		if(event.getSource()==random)                // add small bounds  
				{
